...
export function DataForm() {
    ...
    useEffect(() => {
        axios.get("https://apiv2.bhtokens.com/api/v1/type-dropdown?apikey=A20RqFwVktRxxRqrKBtmi6ud")
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
   axios
      .post("https://apiv2.bhtokens.com/api/v1/wallet-addresses?apikey=A20RqFwVktRxxRqrKBtmi6ud", values)
      .then((res) => {

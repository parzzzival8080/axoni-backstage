...
export function DataForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.fluxcoin.tech/api/v1/user-dropdown?apikey=A20RqFwVktRxxRqrKBtmi6ud"
      )
    ...
    axios
      .get(
        "https://api.fluxcoin.tech/api/v1/network-dropdown?apikey=A20RqFwVktRxxRqrKBtmi6ud"
      )
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    axios
      .post(
        "https://api.fluxcoin.tech/api/v1/transactions?apikey=A20RqFwVktRxxRqrKBtmi6ud",
        values
      )
      .then((res) => {

        ...
        try {
          if (confirmAction === "trend") {
            if (trends.trend_status == "on") {
              await axios.put(
                "https://api.fluxcoin.tech/api/v1/update-trend-status?apikey=5lPMMw7mIuyzQQDjlKJbe0dY",
                {
                  trend_status: "off",
            ...
            if (trends.manual_status == "off") {
              await axios.put(
                "https://api.fluxcoin.tech/api/v1/update-manual-status?apikey=5lPMMw7mIuyzQQDjlKJbe0dY",
                {
                  manual_status: "on",
                  coin_pair_id: trends.id,
                }
